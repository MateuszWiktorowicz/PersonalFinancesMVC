                            ...
                            <div class="d-flex gap-3">
                                ...
                                <div>
                                    <form action="/incomeCategories/<?php echo escapeData($category['id']) ?>" method="POST">
                                        ...
                                        <button type="submit" class="text-reset text-decoration-none" <?php echo $category['transactionNo'] !== false ? 'disabled' : ''; ?>>
                                            <i class="fa-solid fa-trash"></i>
                                        </button>
                                    </form>
                                </div>
                                <div>
                                    <?php echo $category['transactionNo'] !== false ? '<a href="/' . $category['id'] . '/transactions"><i class="fa-solid fa-money-bill-transfer fs-4"></i></a>' : ''; ?>
