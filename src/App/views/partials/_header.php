...
<head>
    ...
    <script src="https://kit.fontawesome.com/57016fd288.js" crossorigin="anonymous"></script>
...
<nav class="navbar bg-body-tertiary">
    <div class="container-sm d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center text-center justify-content-end gap-3 p-3 col-3">
            ...
            <?php else : ?>
                <div><a class="text-reset text-decoration-none fs-4" href="/settings"><i class="fa-solid fa-gears"></i></a></div>
                <div><a class="text-reset text-decoration-none fs-4" href="/logout"><i class="fa-solid fa-right-from-bracket"></i></a></div>
            <?php endif; ?>
        </div>
    </div>
</nav>